...
export const metadata: Metadata = {
  ...
  description: "Learn how to build consumer apps using AI and scale them with short-form content. Master faceless content systems, app ideation, and startup growth.",
  keywords: "app building, AI tools, indie hackers, founders, short-form content, TikTok growth, app monetization",
  openGraph: {
    title: "Buildercult - Build Apps with AI & Grow with Content",
    description: "The AI-first education platform for creators, indie hackers, and solo founders.",
  ...
  twitter: {
    ...
    title: "Buildercult - Build Apps with AI & Grow with Content",
    description: "Learn how to build consumer apps using AI and scale them with short-form content."
  },
  robots: {
    index: true,
    follow: true
